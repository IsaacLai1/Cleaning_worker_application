  ...
  static final Map<Locale, AppLocalizations_Labels> languages = {
    ...
    Locale.fromSubtags(languageCode: "fi"): AppLocalizations_Labels(
      auth: AppLocalizations_Labels_Auth(
        ...
        resetPasswordButton: "Send salasanan palauttaminen",
        emailFormField: "Sähköposti",
        passwordFormField: "Salasana",
        nameFormField: "Nimi",
        signInErrorTitle: "Kirjautumisvirhe",
        signInError:
            "Kirjautuminen epäonnistui: sähköpostitse tai salasana väärin.",
        resetPasswordLabelButton: "Unohtuiko salasana?",
        signUpLabelButton: "Luo tili",
        signUpErrorTitle: "Rekisteröityminen epäonnistui.",
        signUpError: "Ongelma rekisteröitymisestä. Yritä uudelleen myöhemmin.",
        signInLabelButton: "On tili? Kirjaudu sisään.",
        resetPasswordNoticeTitle: "Salasananvaihtosähköposti lähetetty",
        resetPasswordNotice:
            "Tarkista sähköpostisi ja seuraa ohjeita uuden salasanan.",
        resetPasswordFailed: "Salasananvaihtosähköposti epäonnistui",
        signInonResetPasswordLabelButton: "Kirjaudu sisään",
        updateUser: "Päivitä profiili",
        updateUserSuccessNoticeTitle: "User Päivitetty",
        updateUserSuccessNotice: "Käyttäjätietojen päivitys onnistui.",
        updateUserFailNotice: "Päivittäminen epäonnistui käyttäjälle",
        enterPassword: "Syötä salasanasi",
        cancel: "Peruuttaa",
        submit: "Lähetä",
        changePasswordLabelButton: "Vaihda salasana",
        resetPasswordTitle: "Nollaa salasana",
        updateProfileTitle: "Päivitä profiili",
        wrongPasswordNoticeTitle: "Kirjautuminen epäonnistui",
        wrongPasswordNotice: "Salasanaa ei vastaa tietojamme.",
      ...
      home: AppLocalizations_Labels_Home(
        ...
        adminUserLabel: "Valvoja Käyttäjä",
      ),
      app: AppLocalizations_Labels_App(
        title: "Flutter Starter Project",
      ),
      validator: AppLocalizations_Labels_Validator(
        ...
        password: "Salasanan on oltava vähintään 6 merkkiä pitkä.",
        name: "Anna nimi.",
        number: "Anna numero.",
        notEmpty: "Tämä on pakollinen kenttä.",
        amount: "Anna numero eli 250 - ei dollarin merkki eikä senttiä",
      ),
    ),
