...
import 'package:worker_app/controllers/auth_controller.dart';
import 'package:worker_app/ui/components/full_photo.dart';
import 'package:worker_app/ui/components/loading.dart';

final AuthController authController1 = AuthController.to;
String uid = authController1.firestoreUser.value.uid;
          ...
          Flexible(
            child: Container(
              child: TextField(
                ...
                style: TextStyle(color: Colors.blue[300], fontSize: 15.0),
